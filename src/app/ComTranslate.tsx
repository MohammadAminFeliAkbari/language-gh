...
function ComTranslate({ englishContent, persionContent }: detail) {  
  ...
  return (  
    <div>  
      ...
      <div className={`text-gray-700 dark:text-gray-400 persian-content transition-height duration-500 ease-in-out ${hidden ? 'max-h-full opacity-100' : 'max-h-0 opacity-0'}`}>  
